...
import aboutUsImage from '../assets/images/aboutUsImg1.png';
...
<div className="about-us">
    <div className="container pt-5">
        <div className="mt-0">
            <div className="row">
                <img className="card-img-top" src={aboutUsImage} alt="..." />
            </div>
        </div>

        <div className="text-center mt-5">
            <img className="about-us-logo card-img-top" src={aboutUsLogo} alt="..." />
